...
var constructRequestQueryString = module.exports.constructRequestQueryString = function(_parameters, _queryString) {
    ...
    if (parameters) {
        ...
        if (parameters['id']) {
            ...
            // Check if the discipline is set
            if (parameters['discipline']) {
                queryString.push('s.fvf=Discipline,' + parameters['discipline'] + ',false');
            }
