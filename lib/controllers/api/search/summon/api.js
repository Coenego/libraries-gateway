...
var getFacetsFromResults = module.exports.getFacetsFromResults = function(parameters, callback) {
    ...
    var facetsCollection = ['s.ff=ContentType,and,1,100','s.ff=Language,and,1,100','s.ff=Discipline,and,1,100'];

    // Predefine some queryString elements
    var queryString = ['s.ps=10', 's.dym=true', 's.debug=false'];
...
var getResults = module.exports.getResults = function(parameters, callback) {
    ...
    // Create a collection of facets
    var facetsCollection = ['s.ff=ContentType,or,1,100','s.ff=Language,or,1,100','s.ff=Discipline,or,1,100'];
